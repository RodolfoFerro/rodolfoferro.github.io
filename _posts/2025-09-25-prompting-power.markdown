---
title: "Prompting Power: Estategias para convertir a la IA en tu mejor empleada"
layout: post
...
category: blog
author: rodferro
description: "Prompting Power: Estategias para convertir a la Inteligencia Artificial en tu mejor empleada"
---

**🚀 ¡Potencia tu poder con la IA!**

Spacio i de Coparmex ZM de León y el Instituto de Innovación, Ciencia y Emprendimiento para la Competitividad  te invitan a la conferencia:

<center>
    <h2>🎤 PROMPTING POWER: Estrategias para convertir a la INTELIGENCIA ARTIFICIAL en tu mejor empleada</h2>
    <h4>📲 Con Rodo Ferro, Machine Learning Geek.</h4>
</center>

<center>  
    <img src="/assets/posts/prompting-power.JPG">
</center>
