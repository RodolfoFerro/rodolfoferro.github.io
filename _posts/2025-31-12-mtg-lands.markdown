...
- **La probabilidad para un _mana flood_:**
  ...
  \begin{align} 
    ...
    &= \mathbb{P}(X = 5) + \mathbb{P}(X = 6) + \mathbb{P}(X = 7) \\
    &\approx 0.0657
  \end{align}
  $$
...
- _Ramp_, cantrips o robos adicionales
...
- Cuestionar heurísticas comunes, es decir, lo que conocemos como _"rules of thumb"_

¡Espero que este post te haya resultado interesante y la herramienta te sea de utilidad!
