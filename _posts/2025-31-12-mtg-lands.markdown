...
\begin{align} 
  ...
  &\approx 0.0657 \text{(6.57\%)}
\end{align}
$$

Estas cantidades resumen muy bien el comportamiento del mazo en la mano inicial, dado un número de tierras dentro de mis 99.
